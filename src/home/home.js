...
const Home = (props) => {
  ...
  <div className="main-home">
      <div className="list">
          <h1>Legal Advice</h1>
          <p> is an online legal services marketplace connecting consumers and lawyers from various law firms across the region. Legal Advice is a technology company. We are not a law firm, and we neither give legal advice nor provide legal services. All advice and services are provided by duly qualified and authorised participating lawyers.</p></div>      
        <div className="list">
<h1>What we do</h1>
